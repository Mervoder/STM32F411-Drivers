...
uint32_t RCC_GetSystemClock(void)
{
	...
	switch(clkSource)
	{
		case 0 : SystemCoreClock = 16000000;
		break;

		case 1 : SystemCoreClock =  8000000;
		break;

// 		case 2 : SystemCoreClock    PLL situation
...
uint32_t RCC_GetPClock2(void)
{
	...
	HPRE2_Value = ((RCC->CFGR >> 13U) & 0x7U) ; // 3 bits important for us
